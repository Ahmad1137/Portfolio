...
const Liveproject = ({ Title, Desc, Src, Link }: LiveprojectProps) => {
  return (
      ...
      <div className="w-full mt-5 flex flex-col  gap-6">
        <div>
          <div className="flex items-center justify-between">
            <h3 className="text-base uppercase text-blue-700 font-normal">
              {Title}
            </h3>
            <div className="flex gap-2">
              <a href={Link} target="_blank">
                <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-gray-400  duration-300 cursor-pointer">
                  Live
                </span>
              </a>
            </div>
