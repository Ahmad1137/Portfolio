...
const Contact = () => {
  ...
  const handelsubmit = (e: any) => {
    e.preventDefault();
    const serviceId = "service_eejlygs";
    const templateId = "template_pi6llcy";
    const publickKey = "R1Qe8J5X6OIluO_GY";
              ...
              <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
                ...
                <div className="w-full">
                  <button
                    ...
                    className="w-full h-12 bg-[#141518] rounded-lg text-base text-gray-400 tracking-wider uppercase hover:text-designColor duration-300 hover:border-[1px] hover:border-white border-gray-600 border"
                  >
                    Send Message
                  </button>
                </div>
                {errMsg && (
                  <p className="py-3 bg-gradient-to-r from-[#141518] to-[#141518] shadow-shadowOne text-center text-designColor text-base tracking-wide animate-bounce">
                    {errMsg}
                  </p>
                )}
                {successMsg && (
